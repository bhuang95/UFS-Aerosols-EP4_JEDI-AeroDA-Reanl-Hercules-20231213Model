...
CNTLDIR_ATMOS_CDATE=${CNTLDIR}/model_data/
ENKFDIR=${ROTDIR}/enkfgdas.${CYMD}/${CH}
DATAHPSSDIR=${ARCHHPSSDIR}/${PSLOT}/dr-data-longfcst-backup/${CDATE}
DATANIAGDIR=${ARCHNIAGDIR}/${PSLOT}/dr-data-longfcst-backup/${CDATE}
