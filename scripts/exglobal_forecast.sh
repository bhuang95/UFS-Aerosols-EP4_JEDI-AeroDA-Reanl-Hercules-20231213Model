...
#${NCP} "/work/noaa/wrf-chem/bhuang/expCodes-Hercules/UFSAerosols-workflow/20231116-develop-recmp20241202/20231116-develop/global-workflow/sorc/ufs_model.fd/tests/ufs_model.x" "${DATA}/"
